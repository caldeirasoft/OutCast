package com.caldeirasoft.outcast.di.hiltmavericks
...
class HiltMavericksViewModelFactory<VM : MavericksViewModel<S>, S : MavericksState>(
    ...
    override fun create(viewModelContext: ViewModelContext, state: S): VM {
        ...
        val viewModelFactoryMap = EntryPoints.get(viewModelComponent,
            HiltMavericksEntryPoint::class.java).viewModelFactories
