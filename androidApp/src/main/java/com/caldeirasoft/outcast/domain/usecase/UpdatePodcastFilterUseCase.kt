...
class UpdatePodcastFilterUseCase @Inject constructor(
    val dataStoreRepository: DataStoreRepository,
) {
    suspend fun execute(feedUrl: String, filter: PodcastFilter) =
        dataStoreRepository.updatePodcastFilter(feedUrl, filter)
}